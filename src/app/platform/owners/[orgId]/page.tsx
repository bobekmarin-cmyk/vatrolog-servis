...
import { ServicerTable, InviteAccountForm, AccountActions } from "./OwnerOrgActions";
            ...
            <tbody>
              {detail.accounts.map((a) => (
                <tr key={a.id} className="border-t border-slate-100">
                  ...
                  <td className="px-3 py-2">
                    <span
                      className={`rounded-full px-2 py-0.5 text-xs font-semibold ${a.role === "ADMIN" ? "bg-red-100 text-red-800" : "bg-slate-100 text-slate-600"}`}
                    >
                      {a.role === "ADMIN" ? "Administrator" : "Član"}
                    </span>
                  </td>
                  <td className="px-3 py-2">
                  ...
                  <td className="px-3 py-2 text-right">
                    <AccountActions orgId={detail.id} ownerId={a.id} role={a.role} />
                  </td>
                </tr>
              ))}
